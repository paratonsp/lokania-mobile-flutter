...
class _HotelListV2UIState extends State<HotelListV2UI> {
  ...
  Widget build(BuildContext context) {
    ...
    String formatToday = DateFormat('EEE, d MMM').format(today);
    DateTime nextDay = today.add(Duration(days: 1));
    String formatNextDay = DateFormat('EEE, d MMM').format(nextDay);
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        titleSpacing: 0.0,
                        ...
                        Expanded(
                          child: Container(
                            child: Column(
                              ...
                              children: <Widget>[
                                Text(
                                  "1 ${lang.translate('screen.hotelList.room')}",
                                  style: TextStyle(
                                    color: primaryColor,
                                    fontWeight: FontWeight.w600,
                                    fontSize: FontSize.s12,
                                ...
                                Container(height: Sizes.s5),
                                Text(
                                  "2 ${lang.translate('screen.hotelList.guest')}",
                                  style: TextStyle(
                                    fontSize: FontSize.s10,
                                  ),
                                ),
