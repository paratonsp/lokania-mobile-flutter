...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.hastaragil.flutter_midtrans_payment.FlutterMidtransPaymentPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin flutter_midtrans_payment, com.hastaragil.flutter_midtrans_payment.FlutterMidtransPaymentPlugin", e);
    }
    try {
